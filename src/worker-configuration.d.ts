/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: e2ee1b414c1b2e5e37609f6b6352708f)
// Runtime types generated with workerd@1.20260826.1 2026-08-27 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	GITHUB_CLIENT_ID: "Iv1.b507a08c87ecfe98";
	VSCODE_VERSION: "1.109.3";
	COPILOT_CHAT_VERSION: "0.37.6";
	GITHUB_API_VERSION: "2026-03-10";
	USER_HUB: DurableObjectNamespace<import("./index").UserHub>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_CLIENT_ID" | "VSCODE_VERSION" | "COPILOT_CHAT_VERSION" | "GITHUB_API_VERSION">> {}
}
